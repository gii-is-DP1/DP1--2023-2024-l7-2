...
public class SpecialCardRestController {
	...
	@PostMapping
	public ResponseEntity<SpecialCard> createSpecialCard(@RequestBody @Valid SpecialCard newSpecialCard,
			BindingResult br) {
	...
	@PutMapping("/{id}")
	public ResponseEntity<Void> modifySpecialCard(@RequestBody @Valid SpecialCard newSpecialCard, BindingResult br,
