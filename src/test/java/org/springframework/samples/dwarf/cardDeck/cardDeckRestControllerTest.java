...
import org.springframework.samples.dwarf.cardDeck.CardDeckController;
...
public class cardDeckRestControllerTest {
    ...
    public void testUpdateCardDeck() {
        ...
        ResponseEntity<CardDeck> response = cardDeckController.updateCardDeck(cardDeckId, updatedCardDeck,
                bindingResult);
        assertEquals(HttpStatus.OK, response.getStatusCode());
        ...
        assertThrows(BadRequestException.class,
                () -> cardDeckController.updateCardDeck(cardDeckId, updatedCardDeck, bindingResult));
    }
}
