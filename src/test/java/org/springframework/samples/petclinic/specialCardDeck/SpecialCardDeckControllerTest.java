...
public class SpecialCardDeckControllerTest {
    ...
    public void testGetSpecialCardDeckById() {
        ...
        assertThrows(ResourceNotFoundException.class, () -> specialCardDeckController.getSpecialCardDeckById(nonExistentSpecialCardDeckId));
    }
    ...
    public void testGetSpecialCard() {
        ...
        assertThrows(ResourceNotFoundException.class, () -> specialCardDeckController.getSpecialCard(nonExistentSpecialCardId));
    }
    ...
    public void testCreateSpecialCardDeck() {
        ...
        ResponseEntity<SpecialCardDeck> response = specialCardDeckController.createSpecialCardDeck(newSpecialCardDeck, bindingResult);
        ...
        assertThrows(BadRequestException.class, () -> specialCardDeckController.createSpecialCardDeck(newSpecialCardDeck, bindingResult));
    }
    ...
    public void testUpdateSpecialCardDeck() {
        ...
        when(bindingResult.hasErrors()).thenReturn(false);
        when(specialCardDeckService.updateSpecialCardDeck(updatedSpecialCardDeck, specialCardDeckId)).thenReturn(updatedSpecialCardDeck);

        ResponseEntity<SpecialCardDeck> response = specialCardDeckController.updateSpecialCardDeck(specialCardDeckId, updatedSpecialCardDeck, bindingResult);
        ...
        when(bindingResult.hasErrors()).thenReturn(true);
        assertThrows(BadRequestException.class, () -> specialCardDeckController.updateSpecialCardDeck(specialCardDeckId, updatedSpecialCardDeck, bindingResult));
    }
}
