...
import org.springframework.samples.petclinic.card.SpecialCardRestController;
...
public class SpecialCardRestControllerTest {
    ...
    public void testCreateSpecialCard() {
        ...
        // Ejecutar el método del controlador y verificar el resultado
        ResponseEntity<SpecialCard> result = specialCardRestController.createSpecialCard(newCard, mock(BindingResult.class));
    ...
    public void testModifySpecialCard() {
        ...
        // Ejecutar el método del controlador y verificar el resultado
        ResponseEntity<Void> result = specialCardRestController.modifySpecialCard(modifiedCard, mock(BindingResult.class), 1);
