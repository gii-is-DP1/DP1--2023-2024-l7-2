...
public class SpecialCardServiceTest {
    ...
    public void testDeleteSpecialCardById() {
        ...
        // Verificar que el método deleteById del repositorio mock se llamó con el ID correcto
    ...
    public void testGetSpecialCardsNonEmptyList() {
        // Configurar el comportamiento del repositorio mock para devolver una lista no vacía
        List<SpecialCard> mockCards = new ArrayList<>();
