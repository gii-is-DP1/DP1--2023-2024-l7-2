...
public class SpecialCardRepositoryTest {
    ...
    public void testSaveAndFindAll() {
        ...
        assertEquals("When resolving actions this round, treat all defend locations as if they are occupied.", allCards.get(0).getDescription(), "Descripción de la tarjeta especial incorrecta");
    }
